...
public class PlayerHealth : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        if(scoreHandler == null) { scoreHandler = GetComponentInParent<PlayerScoreHandler>(); }
        if(restraintMeterScript == null) { restraintMeterScript = GetComponentInParent<RestraintMeter>(); }
    }
